package com.votecounter.security;

import com.votecounter.security.jwt.AuthTokenFilter;
...
public class SecurityConfig {
    ...
    //***********CORS AYARLARI ***********************
    // port ayarları için yapılır. development aşamasında bu şekilde olur ve tüm portlara izin verilir ve güvenliksizdir.
    // deployment aşamasında değiştirilir
    @Bean
